...
type IAgentDo interface {
	...
	FilterWithNameAndRole(name string, role string) (result []model.Agent, err error)
}

// SELECT * FROM @@table WHERE name = @name{{if role !=""}} AND role = @role{{end}}
func (a agentDo) FilterWithNameAndRole(name string, role string) (result []model.Agent, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, name)
	generateSQL.WriteString("SELECT * FROM agents WHERE name = ? ")
	if role != "" {
